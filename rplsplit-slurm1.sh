...
DPT.objects.processDirs(dirs=None, objtype=pyh.RPLSplit, channel=[30]); \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:879091842365:awsnotify --message "RPLSplitJobDone"
